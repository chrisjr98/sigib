...
import { GradoEntity } from "src/grado/grado.entity";
...
export class EstudianteEntity {
    ...
    @OneToMany(type => MatriculaEntity, matricula => matricula.estudiante)
    matricula: MatriculaEntity[];

    @ManyToOne(type => CarreraEntity, carrera => carrera.estudiante)
