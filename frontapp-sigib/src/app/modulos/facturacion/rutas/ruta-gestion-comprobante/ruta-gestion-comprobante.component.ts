      ...
      .subscribe((registroCreado: ComprobanteInterface) => {
        if (registroCreado) {
          if (comprobanteSeleccionado) {
            const indiceRegistro = this.comprobante.indexOf(comprobanteSeleccionado);
            this.comprobante[indiceRegistro] = registroCreado;
          } else {
            this.comprobante.unshift(registroCreado);
          }
        }
      });
