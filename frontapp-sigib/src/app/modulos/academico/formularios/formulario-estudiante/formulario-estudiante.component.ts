...
export class FormularioEstudianteComponent implements OnInit {
  ...
  @Output() estudianteValido: EventEmitter< EstudianteRestService| boolean> = new EventEmitter();
  ...
  private _inicializarFormulario() {
    this.formularioEstudiante = this._formBuilder.group({
      cedula: [this.estudiante ? this.estudiante.cedula : '', VALIDACION_CEDULA_ESTUDIANTE],
      nombre: [this.estudiante ? this.estudiante.nombre : '', VALIDACION_NOMBRE_ESTUDIANTE],
      apellido: [this.estudiante ? this.estudiante.apellido : '', VALIDACION_APELLIDO_ESTUDIANTE],
      telefono: [this.estudiante ? this.estudiante.telefono : '', VALIDACION_TELEFONO_ESTUDIANTE],
      correo: [this.estudiante ? this.estudiante.correo : '', VALIDACION_CORREO_ESTUDIANTE],
      carrera: [this.estudiante ? this.estudiante.carrera : '', VALIDACION_CARRERA_ESTUDIANTE],

    });
  }

  private _verificarCamposFormulario() {
    this.verificarCampoFormControl('cedula', MENSAJES_VALIDACION_CEDULA_ESTUDIANTE);
    this.verificarCampoFormControl('nombre', MENSAJES_VALIDACION_NOMBRE_ESTUDIANTE);
    this.verificarCampoFormControl('apellido', MENSAJES_VALIDACION_APELLIDO_ESTUDIANTE);
    this.verificarCampoFormControl('telefono', MENSAJES_VALIDACION_TELEFONO_ESTUDIANTE);
    this.verificarCampoFormControl('correo', MENSAJES_VALIDACION_CORREO_ESTUDIANTE);
    this.verificarCampoFormControl('carrera', MENSAJES_VALIDACION_TELEFONO_ESTUDIANTE);
  }
